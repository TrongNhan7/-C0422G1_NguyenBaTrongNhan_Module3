        ...
        <nav class="navbar">
            <div class="container ">
                <a class="navbar-brand" href="#">
                    <img src="img/Logo-FURAMA-RESORT.jpg" alt="" width="100" height="100">
                </a>
                <span><a class="text-decoration-none" href="#">Nhân Bá Trọng</a></span>
            </div>
        </nav>
    </div>
</header>
        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    <h6 class="text-uppercase fw-bold">Furama Resort</h6>
                    <hr
                    ...
                    <p>
                        ...
                        dẫn nhất Châu Á. Chỉ cách Đà Nẵng một quãng lái xe ngắn là bốn Di sản Văn hóa
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <p>
                        <a href="#!" class="text-white text-decoration-none">3.Thánh địa Mỹ Sơn</a>
                    </p>
                    <p>
                        <a href="#!" class="text-white text-decoration-none">4.Động Phong Nha</a>
                    </p>
                </div>
